...
Object.assign(window, {
  applyPreset, closeRituelActions, closeRituelChemin, closeRituelSelect, cmAfter, cmAnchors,
  cmAutoSave, cmBack, cmBackToList, cmBindCalib, cmBindLongPress, cmBindSwipe,
  cmBldK, cmBoxCost, cmBoxGap, cmBoxOverlap, cmCat2Phase, cmClear,
  cmCloseMenu, cmClosePanel, cmClosePop, cmComputeFilled, cmCurrentRitual, cmDelete,
  cmDraftFor, cmDraftHasProduct, cmEnterRitual, cmFinishEdit, cmFitPaint, cmFitPanelText,
  cmFitScene, cmGroups, cmGuideActive, cmHeadBottom, cmInfo, cmLayout,
  cmLayoutScene, cmLoadProducts, cmMaybeGuide, cmMomentIcon, cmMomentMeta, cmNavGlass,
  cmNavTuck, cmNearest, cmNodeHtml, cmOpenCarousel, cmOpenPanel, cmPaintHtml,
  cmPanelDelete, cmPanelDuplicate, cmPanelEdit, cmPanelGoTab, cmPanelNew, cmPanelRappel,
  cmPanelRender, cmPanelSelect, cmPanelSteps, cmPanelToggleActif, cmPathHalf, cmPersist,
  cmPick, cmPlaceNodes, cmPlacePaint, cmPlacePanel, cmProductsForPhase, cmRename,
  cmRender, cmRibbon, cmSaveIfEditing, cmSceneHtml, cmSetMode, cmSheetHead,
  cmSheetZoom, cmShowProduct, cmShowSlot, cmShowStation, cmSwipeMoment, cmTheme,
  cmTipHtml, cmTogglePanel, cmWow, cmWowClose, copierRituel, copierRituelVers,
  ensureActiveRituels, hasAnyProduct, loadRitual, loadRituels, momentBadge, noProductSheet,
  openRituelActions, openRituelChemin, openRituelQuick, openRituelSelect, pcEmptyHtml, pcGoalHtml,
  pcMomentBadge, pcProdChip, pickActive, ractCopier, ractModifier, ractSupprimer,
  recomputeRituelType, renderHomeVoyage, renderParcours, renderRituelActuel, renderRituelCout, renderRituelsHub,
  rhCard, rhGoTab, rhNewRituel, rhSyncActif, rhToggleActif, rhTrail,
  rpAutoTab, rpTabGo, selectRituel, toggleHrList, togglePcLea, 
});
